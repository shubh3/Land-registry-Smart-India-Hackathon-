  ...
  render() {
    ...
    return (
          ...
          <main role="main" className="col-lg-12 ml-auto mr-auto" style={{ maxWidth: '850px' }}>
            <div className="content mr-auto ml-auto">
              ...
              <p>&nbsp;</p>
                 ...
                 <div align="center" >
      <h1 id="ab">Electricity portal</h1>
      <br/>
      </div>
      ...
      <form  onSubmit={(event) => {
                  ...
                  const elect= this.elect.value
                 const valid =true
                   this.props.electric(elect,valid)
                ...
                <button type="submit" className="btn btn-primary">All clear</button>   <p>          </p>
                 ...
                 <button className="btn btn-primary" id="close-CSS1" type="submit" onClick={(event) => {
                  event.preventDefault()
                 const land= this.elect.value
                 const valid=false
                   this.props.electric(land,valid)
                   ...
                   Land number  :     {post.tokenid}
                    ...
                    <ul id="postList" className="list-group list-group-flush">
                     ...
                     <li key={key} className="list-group-item py-2">
                        ...
                        Electricity : {post.elec ? <img className='mr-3' width='50' height='50' src={r} align="middle" /> :<img className='mr-3' width='35' height='35' src={w} />}
