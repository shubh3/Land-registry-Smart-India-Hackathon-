    ...
    return (
      ...
      <form  onSubmit={(event) => {
                ...
                <button type="submit" className="btn btn-primary ">All clear</button>   <p>          </p>
                  ...
                  event.preventDefault()
                 const land= this.loan.value
                 const valid=false
                   this.props.loan(land,valid)
                   ...
                   Land number  :     {post.tokenid}
                    ...
                    <ul id="postList" className="list-group list-group-flush">
                     ...
                     <li key={key} className="list-group-item py-2">
                        ...
                        Bank    : {post.bank ? <img className='mr-3' width='50' height='50' src={r} align="middle" /> :<img className='mr-3' width='35' height='35' src={w} />}
